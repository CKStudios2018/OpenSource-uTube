(function(g){var window=this;'use strict';var w4=function(a){g.V.call(this,{D:"div",K:"utp-miniplayer-ui"});this.Rf=!1;this.player=a;this.N(a,"minimized",this.Xf);this.N(a,"onStateChange",this.yC)},x4=function(a){g.dM.call(this,a);
    this.i=new w4(this.player);this.i.hide();g.GL(this.player,this.i.element,4);a.Ce()&&(this.load(),g.L(a.getRootNode(),"utp-player-minimized",!0))};
    g.v(w4,g.V);g.k=w4.prototype;
    g.k.QA=function(){this.tooltip=new g.CP(this.player,this);g.G(this,this.tooltip);g.GL(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.kc=new g.ZM(this.player);g.G(this,this.kc);this.eg=new g.V({D:"div",K:"utp-miniplayer-scrim"});g.G(this,this.eg);this.eg.ya(this.element);this.N(this.eg.element,"click",this.Sw);var a=new g.V({D:"button",Ca:["utp-miniplayer-close-button","utp-button"],U:{"aria-label":"Close"},S:[g.VJ()]});g.G(this,a);a.ya(this.eg.element);this.N(a.element,"click",this.Hh);
    a=new g.b0(this.player,this);g.G(this,a);a.ya(this.eg.element);this.Jn=new g.V({D:"div",K:"utp-miniplayer-controls"});g.G(this,this.Jn);this.Jn.ya(this.eg.element);this.N(this.Jn.element,"click",this.Sw);var b=new g.V({D:"div",K:"utp-miniplayer-button-container"});g.G(this,b);b.ya(this.Jn.element);a=new g.V({D:"div",K:"utp-miniplayer-play-button-container"});g.G(this,a);a.ya(this.Jn.element);var c=new g.V({D:"div",K:"utp-miniplayer-button-container"});g.G(this,c);c.ya(this.Jn.element);this.HI=new g.zO(this.player,
    this,!1);g.G(this,this.HI);this.HI.ya(b.element);b=new g.wO(this.player,this);g.G(this,b);b.ya(a.element);this.nextButton=new g.zO(this.player,this,!0);g.G(this,this.nextButton);this.nextButton.ya(c.element);this.gg=new g.pP(this.player,this);g.G(this,this.gg);this.gg.ya(this.eg.element);this.Ec=new g.EO(this.player,this);g.G(this,this.Ec);g.GL(this.player,this.Ec.element,4);this.Fw=new g.V({D:"div",K:"utp-miniplayer-buttons"});g.G(this,this.Fw);g.GL(this.player,this.Fw.element,4);a=new g.V({D:"button",
    Ca:["utp-miniplayer-close-button","utp-button"],U:{"aria-label":"Close"},S:[g.VJ()]});g.G(this,a);a.ya(this.Fw.element);this.N(a.element,"click",this.Hh);a=new g.V({D:"button",Ca:["utp-miniplayer-replay-button","utp-button"],U:{"aria-label":"Close"},S:[g.$J()]});g.G(this,a);a.ya(this.Fw.element);this.N(a.element,"click",this.hR);this.N(this.player,"presentingplayerstatechange",this.Dc);this.N(this.player,"appresize",this.rb);this.N(this.player,"fullscreentoggled",this.rb);this.rb()};
    ...
    g.k.Xf=function(){g.L(this.player.getRootNode(),"utp-player-minimized",this.player.Ce())};
    ...
    x4.prototype.unload=function(){this.player.showControls();this.i.hide()};g.oM.miniplayer=x4;})(_ut_player);
